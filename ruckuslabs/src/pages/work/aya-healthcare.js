...
export default function WorkPage() {
  ...
  const pageTitle = "Aya Healthcare";
  ...
  const designSystemItems = [
    ...
    {
      "title": "Course Completion Page Layout",
      "description": "Clear actions, ample space, and consistency are central to Lawline's visual language.",
      "src": `https://via.placeholder.com/200x200`,
    },
  ]
  ...
  return (
    <Layout location="work/chicory" title={pageTitle}>
      ...
      <section>
        ...
        <ShowcaseGrid items={designSystemItems} />
      </section>
      <section>
        ...
        <ShowcaseGrid items={courseCatalogItems} />
      </section>
      <BrowseMore />
    </Layout>
